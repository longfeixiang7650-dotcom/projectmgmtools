  ...
  Marketing: [
    {
      ...
      a: "HubSpot Marketing Hub provides exceptional value for mid-market teams that need an all-in-one solution. The free CRM integration, smart content engine, and AI content strategy tools justify the cost for teams that will use the full suite. However, the jump from Starter ($15/mo) to Pro ($890/mo) is steep.",
    },
    {
      q: "What's the best email marketing platform for businesses?",
      a: "For email marketing, HubSpot is the gold standard for integrated CRM+email. Mailchimp is best for simplicity and ease of use. Marketo Engage leads enterprise-level email automation. Consider your contact list size, automation complexity, and CRM integration needs.",
    },
    {
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <header className="mb-12">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#0891B2]/20 to-[#06B6D4]/20 flex items-center justify-center">
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-4 px-4 text-right">
                        <Link
                          href={`/tools/${tool.id}`}
                          className="inline-flex items-center gap-1 text-[#0891B2] hover:text-[#06B6D4] transition-colors text-xs font-semibold"
                        >
                ...
                >
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="font-bold text-[#F0F2FE] group-hover:text-[#0891B2] transition-colors truncate">
                        {tool.name}
                      </h3>
                  ...
                  <div className="text-xs text-[#06B6D4] font-medium mb-3">
                    {tool.pricing}
                  </div>
        ...
        <section className="mb-14">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              ...
              >
                <summary className="px-6 py-4 cursor-pointer text-[#F0F2FE] font-semibold text-sm flex items-center justify-between group-open:text-[#06B6D4] transition-colors">
                  {faq.q}
        ...
        <section className="bg-gradient-to-r from-[#162540] to-[#0F1F2D] border border-[#1E3A5F] rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {topTool && (
              <Link
                href={`/tools/${topTool.id}`}
                className="px-6 py-3 bg-[#0891B2] hover:bg-[#067A9A] text-white text-sm font-medium rounded-full transition-colors"
              >
