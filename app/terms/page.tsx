      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#839BBE] leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using the ProjectMgmtTools website (the "Site"), you agree to be
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content — are owned by ProjectMgmtTools and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of ProjectMgmtTools. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              ...
              controlled by ProjectMgmtTools. We have no control over, and assume no
          ...
          <section>
            ...
            <p>
              ProjectMgmtTools offers free access to our directory and comparison features.
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, ProjectMgmtTools, its officers, directors,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless ProjectMgmtTools and its
